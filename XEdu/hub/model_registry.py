...
register_model(ModelMetadata(
    ...
    mirror_urls=[
        "https://raw.githubusercontent.com/PINTO0309/hand-gesture-recognition-using-onnx/main/model/palm_detection/palm_detection_full_inf_post_192x192.onnx",
        "https://raw.githubusercontent.com/betodamian/RealtimeONNXHandtracking/main/palm_detection_full_inf_post_192x192.onnx",
    ],
...
# Keep the legacy model selectable without making it the default.
register_model(ModelMetadata(
    task_name="det_hand",
